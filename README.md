...
⚡ Please show me that you can successfully run the [test.py](https://github.com/DongYang26/CSC8370_2026Full/blob/main/test.py) file in your environment.
...
```
git clone git@github.com:DongYang26/CSC8370_2026Full.git
```
